(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_238dc5._.js", {
...
const uploadImage = async (image, fieldName)=>{
    if (image) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].storage.from('productos').upload(`images/${Date.now()}_${fieldName}.jpg`, image, {
...
const createProduct = async (product)=>{
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from('productos').insert([
            {
                nombre: product.name,
...
const getProducts = async ()=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from('productos').select('*');
        if (error) throw error;
        return data;
    } catch (error) {
...
const getProductById = async (id)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from('productos').select('*').eq('id', id).single();
        if (error) throw error;
        return data;
    } catch (error) {
...
const updateProduct = async (id, product)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from('productos').update({
            nombre: product.name,
            descripcion: product.description || '',
            precio: parseFloat(product.price) || null,
            fragancia: product.fragancia,
...
const deleteProduct = async (id)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from('productos').delete().eq('id', id);
        if (error) throw error;
        return data;
    } catch (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Admin$2f$fileUpload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/components/Admin/fileUpload.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseServices$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/supabaseServices.js [app-client] (ecmascript)"); // Importamos la función para crear productos
...
const ProductPublish = ()=>{
    ...
    const handlePublish = async ()=>{
        try {
            const productData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseServices$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createProduct"])(product);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Error al publicar el producto: ' + error.message);
        }
    };
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$Paper$2f$Paper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Paper$3e$__["Paper"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Admin$2f$fileUpload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            onFileSelect: (e)=>handleImageUpload(e, 'image'),
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Admin$2f$fileUpload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            onFileSelect: (e)=>handleImageUpload(e, 'image1'),
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Admin$2f$fileUpload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            onFileSelect: (e)=>handleImageUpload(e, 'image2'),
...
_s(ProductPublish, "qOFujf461UHxtj0Wpp+WPViugIg=");
_c = ProductPublish;
...
//# sourceMappingURL=_238dc5._.js.map