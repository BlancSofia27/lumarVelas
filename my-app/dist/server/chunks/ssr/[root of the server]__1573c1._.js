...
"[project]/app/adminPanel/productos/page.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    const handleDelete = async (productId)=>{
        try {
            ...
            if (result.isConfirmed) {
                ...
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("products").delete().eq("id", productId);
                if (error) {
                    throw error;
                }
                // Refrescar los productos después de eliminar
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire("¡Eliminado!", "El producto ha sido eliminado.", "success");
                fetchProducts(); // Volver a cargar los productos después de la eliminación
            }
        } catch (error) {
            console.error("Error al eliminar el producto:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire("Error", "Hubo un problema al eliminar el producto.", "error");
        }
    };
...
"[project]/app/adminPanel/productos/page.jsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1573c1._.js.map