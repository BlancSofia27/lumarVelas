...
const api = {
    oauth: {
        ...
        async exchangeCode (code) {
            const oauth = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OAuth"](mercadopago);
            try {
                ...
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('sellers').upsert([
                    {
                        user_id,
                        access_token,
                        refresh_token
    ...
    sale: {
        async create ({ sellerId, items, totalAmount }) {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('sellers').select('access_token').eq('user_id', sellerId).single();
            if (error || !data) {
            ...
            const { data: saleData, error: saleError } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('sales').insert([
                {
...
"[project]/components/ClientAuthorization.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/paymentResume/page.js [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4fbfac._.js.map