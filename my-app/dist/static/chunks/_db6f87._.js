(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_db6f87._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/image.js [app-client] (ecmascript)"); // Asegúrate de importar Image correctamente
...
const ProductForm = ()=>{
    ...
    const [intensity, setIntensity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1); // Estado para la intensidad
    ...
    const uploadImageToSupabase = async (file, folder)=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(folder) // Aquí se usa el nuevo bucket "products"
            ...
            const publicURL = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from("products").getPublicUrl(data.path); // Referencia al bucket "products"
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("products").insert([
                {
                    name,
                    fragance,
                    description,
...
_s(ProductForm, "OLwYCRSo2JMNzKmoyFCRd3ASpJE=");
_c = ProductForm;
...
//# sourceMappingURL=_db6f87._.js.map