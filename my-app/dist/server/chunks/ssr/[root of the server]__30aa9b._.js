...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseServices$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/supabaseServices.js [app-ssr] (ecmascript)"); // Asegúrate de tener la función para subir imágenes a Supabase
...
const ProductPublish = ()=>{
    ...
    const handleImageUpload = async (e)=>{
        ...
        if (file) {
            const uploadedImageUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseServices$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadImage"])(file); // Usando la función uploadImage para subir la imagen a Supabase
            setProduct((prev)=>({
                    ...prev,
    ...
    const handlePublish = ()=>{
        // Aquí debes hacer la conexión con Supabase para guardar los datos del producto
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__30aa9b._.js.map