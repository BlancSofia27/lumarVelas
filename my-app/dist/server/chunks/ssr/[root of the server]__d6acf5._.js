...
;
;
const mercadopago = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MercadoPagoConfig"]({
...
const api = {
    user: {
        async fetch () {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('clients').select('*').single(); // Asegura que solo devuelvas un objeto
            if (error) {
        ...
        async update (data) {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('clients').update(data) // Actualiza la fila existente con los datos proporcionados
        ...
        async authorize () {
            ...
            const url = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OAuth"](mercadopago).getAuthorizationURL({
                options: {
        ...
        async connect (code) {
            ...
            const credentials = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OAuth"](mercadopago).create({
                body: {
                    client_id: ("TURBOPACK compile-time value", "6463485720081234"),
    ...
    message: {
        async list () {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("messages") // Tu tabla de mensajes en Supabase
        ...
        async add (text) {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("messages").insert([
                {
                    text
                }
            ]);
        ...
        async submit (text) {
            ...
            const { data: clientData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('clients') // Nombre de la tabla donde está la columna marketplace
            ...
            const preference = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Preference"](client).create({
                body: {
                    items,
                    metadata: {
                        text
...
"[project]/app/api/payment-success/page.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/api.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function PaymentSuccess() {
    ...
    const [status, setStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("Procesando pago...");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function addMessage() {
            if (!text) return setStatus("Error: No se recibió el mensaje");
            try {
                console.log("Agregando mensaje:", text);
                await __TURBOPACK__imported__module__$5b$project$5d2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].message.add(text); // Solo pasamos el texto
...
"[project]/app/api/payment-success/page.jsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d6acf5._.js.map