...
const api = {
    ...
    message: {
        ...
        async add (message) {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('messages') // Asegúrate de que esta tabla exista en tu base de datos de Supabase
            .insert([
                message
...
"[project]/app/api/mercadopago/connect/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const revalidate = 10; // Revalidar cada 10 segundos, por ejemplo
async function GET(request) {
    // Obtenemos el code de la request
    const code = request.nextUrl.searchParams.get("code");
    // Conectamos al usuario con el code y obtenemos las credenciales
    const credentials = await __TURBOPACK__imported__module__$5b$project$5d2f$api$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.connect(code);
    // Actualizamos las credenciales del usuario
    await __TURBOPACK__imported__module__$5b$project$5d2f$api$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.update({
        marketplace: credentials.access_token
    });
    // Redirigimos al usuario a la página del marketplace
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${process.env.APP_URL}/api/paymentResume`);
}
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__799c63._.js.map