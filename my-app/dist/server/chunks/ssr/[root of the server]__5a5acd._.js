...
async function ResumePage() {
    ...
    const { data: client, error: clientError } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from("clients").select("*").eq("email", "cliente@example.com") // Aquí pones el email o alguna otra forma de identificar al cliente
    .single();
    if (clientError) {
    ...
    const authorizationUrl = client.mp_user_id ? null : await __TURBOPACK__imported__module__$5b$project$5d2f$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].user.authorize();
