(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_e54ea6._.js", {
...
const api = {
    oauth: {
        ...
        getAuthURL () {
            const clientId = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.MP_CLIENT_ID;
            const redirectUri = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.MP_REDIRECT_URI;
        ...
        async exchangeCode (code) {
            const oauth = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OAuth"](mercadopago);
            try {
                const response = await oauth.token({
                    ...
                    code,
                    redirect_uri: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.MP_REDIRECT_URI
                });
                const { access_token, refresh_token, user_id } = response;
                // Guardar el access_token del vendedor en Supabase
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('sellers').upsert([
                    {
                        user_id,
                        access_token,
                        refresh_token
    ...
    sale: {
        async create ({ sellerId, items, totalAmount }) {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('sellers').select('access_token').eq('user_id', sellerId).single();
            if (error || !data) {
            ...
            const { data: saleData, error: saleError } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('sales').insert([
                {
...
"[project]/components/ClientAuthorization.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const ClientAuthorization = ({ mpUserId })=>{
    ...
    const authorizationUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.MP_AUTHORIZATION_URL || "";
...
_c = ClientAuthorization;
const __TURBOPACK__default__export__ = ClientAuthorization;
var _c;
__turbopack_refresh__.register(_c, "ClientAuthorization");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_e54ea6._.js.map