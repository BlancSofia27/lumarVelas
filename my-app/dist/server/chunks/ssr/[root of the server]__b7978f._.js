...
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(process.env.SUPABASE_URL, process.env.SUPABASE_SERVICE_ROLE);
...
const api = {
    user: {
        async fetch () {
            ...
            const { data, error } = await supabase.from('users') // Cambia 'users' por tu tabla de usuarios
            .select('*').eq('id', process.env.USER_ID) // Reemplaza con el ID del usuario
            .single();
            if (error) {
        ...
        async update (data) {
            ...
            const { data: updatedData, error } = await supabase.from('users') // Cambia 'users' por tu tabla de usuarios
            .update(data).eq('id', process.env.USER_ID); // Usa el ID del usuario
            if (error) {
        ...
        async authorize () {
            ...
            const url = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["OAuth"](mercadopago).getAuthorizationURL({
                options: {
                    client_id: ("TURBOPACK compile-time value", "7553294176291462"),
    ...
    sale: {
        ...
        async getSaleDetails (saleId) {
            ...
            const { data, error } = await supabase.from('sales').select('*').eq('sale_id', saleId).single();
            if (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PurchaseResume$2e$jsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/components/PurchaseResume.jsx [app-rsc] (ecmascript)");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b7978f._.js.map