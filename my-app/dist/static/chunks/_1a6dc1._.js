(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_1a6dc1._.js", {
...
"[project]/utils/supabaseServices.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const uploadImage = async (image, fieldName)=>{
    if (image) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('productos').upload(`images/${Date.now()}_${fieldName}.jpg`, image, {
...
const createProduct = async (product)=>{
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('productos').insert([
            {
                nombre: product.name,
...
const getProducts = async ()=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('productos').select('*');
        if (error) throw error;
        return data;
    } catch (error) {
...
const getProductById = async (id)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('productos').select('*').eq('id', id).single();
        if (error) throw error;
        return data;
    } catch (error) {
...
const updateProduct = async (id, product)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('productos').update({
            nombre: product.name,
            descripcion: product.description || '',
            precio: parseFloat(product.price) || null,
            fragancia: product.fragancia,
...
const deleteProduct = async (id)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('productos').delete().eq('id', id);
        if (error) throw error;
        return data;
    } catch (error) {
...
"[project]/components/Admin/prevCard.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/image.js [app-client] (ecmascript)"); // Si usas Next.js, puedes usar este componente para optimizar las imágenes
...
var _c;
__turbopack_refresh__.register(_c, "PrevCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseServices$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/supabaseServices.js [app-client] (ecmascript)"); // Aquí importamos tu función uploadImage
...
const ProductPublish = ()=>{
    ...
    const handleImageUpload = async (e)=>{
        ...
        if (file) {
            try {
                const uploadedImageUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseServices$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadImage"])(file); // Usamos tu función uploadImage
                setProduct((prev)=>({
                        ...prev,
                        image: uploadedImageUrl
                    }));
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Error al cargar la imagen");
    ...
    const handlePublish = async ()=>{
        try {
            ...
            if (response.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Producto publicado con éxito");
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Error al publicar el producto");
            }
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Error al publicar el producto");
...
_s(ProductPublish, "7iZSjnTe6ontAXaFygO7FX1sLzQ=");
_c = ProductPublish;
const __TURBOPACK__default__export__ = ProductPublish;
var _c;
__turbopack_refresh__.register(_c, "ProductPublish");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_1a6dc1._.js.map