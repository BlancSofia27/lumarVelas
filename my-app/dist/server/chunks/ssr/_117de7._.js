...
"[project]/utils/naveService.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getAuthToken() {
    const response = await fetch('https://homoservices.apinaranja.com/security-ms/api/security/auth0/b2b/m2ms', {
        ...
        body: JSON.stringify({
            ...
            audience: process.env.NAVE_AUDIENCE,
            cache: true
        })
    });
    if (!response.ok) {
...
"[project]/utils/payamentService.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$naveService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/naveService.js [app-ssr] (ecmascript)");
;
async function createPaymentIntent(paymentDetails) {
    const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$naveService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthToken"])();
...
"[project]/components/pay.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$payamentService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/payamentService.js [app-ssr] (ecmascript)"); // Asegúrate de configurar esta función
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/react-redux/dist/react-redux.mjs [app-ssr] (ecmascript)"); // Para acceder al carrito en el state global
"use client";
;
;
;
...
const PurchaseSummary = ()=>{
    const cart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])((state)=>state.cart); // Acceso al carrito desde Redux
    ...
    const handlePayWithQR = async ()=>{
        ...
        try {
            ...
            const paymentIntent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$payamentService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createPaymentIntent"])(paymentDetails);
...
"[project]/app/user/payamentResume/page.jsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_117de7._.js.map