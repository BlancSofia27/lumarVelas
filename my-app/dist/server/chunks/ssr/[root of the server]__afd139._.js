...
"[project]/components/Admin/fraganceForm.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const FraganceModal = ()=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        setIsLoading(true);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("fragances") // Reemplaza con el nombre de tu tabla en Supabase
        .insert([
            formData
        ]);
        if (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__afd139._.js.map