...
const api = {
    user: {
        async fetch () {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('clients').select('*').single(); // Asegura que solo devuelvas un objeto
            if (error) {
        ...
        async update (data) {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('clients').update(data) // Actualiza la fila existente con los datos proporcionados
    ...
    message: {
        async list () {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from("messages") // Tu tabla de mensajes en Supabase
        ...
        async submit (text) {
            ...
            const { data: clientData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('clients') // Nombre de la tabla donde está la columna marketplace
...
/*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ $$RSC_SERVER_ACTION_0 = async function add(formData) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c21e07._.js.map