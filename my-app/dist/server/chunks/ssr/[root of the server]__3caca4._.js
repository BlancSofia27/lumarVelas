    ...
    const handleSignUp = async ()=>{
        ...
        try {
            ...
            if (error) {
                ...
                const { data, error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users') // Asegúrate de tener una tabla de usuarios
                .upsert([
                    {
                        email,
                        phone
...
"[project]/app/user/layout.tsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__3caca4._.js.map