...
const api = {
    user: {
        async fetch () {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('clients').select('*');
            if (error) {
        ...
        async update (data) {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('clients').upsert(data, {
                onConflict: [
                    'id'
                ]
    ...
    message: {
        ...
        async add (message) {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('messages') // Asegúrate de que esta tabla exista en tu base de datos de Supabase
            .insert([
                message
        ...
        async submit (text) {
            ...
            const preference = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Preference"](client).create({
                body: {
                    ...
                    marketplace_fee: unit_price * 0.10
                }
            });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__3b8bb4._.js.map