  ...
  return (
    <div
      className={`fixed top-0 left-0 right-0 z-50 w-full transition-all duration-300 text-white ${
        isScrolled ? "bg-negro shadow-md p-2 " : "bg-transparent mt-10 md:mt-2 lg:mt-3 lx:mt-3 sm:pt-10 md:pt-6 lg:pt-4 xl:pt-3 px-2"
      }`}
    >
      <div
        className={`flex items-center justify-between lg:px-4 xl:px-4 w-full cursor-pointer ${
          isScrolled
            ? "mt-1"
            : "mt-1" // Más margen en pantallas grandes
        }`}
      >
