...
"[project]/utils/supabaseClient.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/api.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/mercadopago/dist/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/supabaseClient.js [app-route] (ecmascript)");
;
;
const mercadopago = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MercadoPagoConfig"]({
...
const api = {
    user: {
        async fetch () {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('clients').select('*').single(); // Asegura que solo devuelvas un objeto
            if (error) {
        ...
        async update (data) {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('clients').update(data) // Actualiza la fila existente con los datos proporcionados
        ...
        async authorize () {
            ...
            const url = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OAuth"](mercadopago).getAuthorizationURL({
                options: {
        ...
        async connect (code) {
            ...
            const credentials = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OAuth"](mercadopago).create({
                body: {
                    client_id: ("TURBOPACK compile-time value", "6463485720081234"),
    ...
    message: {
        async list () {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("messages") // Tu tabla de mensajes en Supabase
        ...
        async add ({ text, id_mercadopago, amount, status }) {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("messages").insert([
                {
                    text,
                    id_mercadopago,
                    amount,
        ...
        async submit (text) {
            ...
            const { data: clientData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('clients') // Nombre de la tabla donde está la columna marketplace
            ...
            const preference = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Preference"](client).create({
                body: {
                    items,
                    metadata: {
                        text
...
"[project]/app/api/mercadopago/pagos/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/mercadopago/dist/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/cache.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$api$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/api.js [app-route] (ecmascript)");
;
;
;
async function POST(request) {
    try {
        ...
        // Obtenemos el pago
        const payment = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mercadopago$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Payment"](__TURBOPACK__imported__module__$5b$project$5d2f$api$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mercadopago"]).get({
            id: body.data.id
        });
        ...
        if (payment.status === "approved") {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$api$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].message.add({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5124a9._.js.map