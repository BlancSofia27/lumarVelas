...
function Auth() {
    ...
    const handleSignUp = async ()=>{
        ...
        setSuccess(false);
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                email,
                password
            });
            if (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1d9742._.js.map